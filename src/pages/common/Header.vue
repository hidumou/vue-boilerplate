<template>
  <nav class="navbar navbar-parking" style="border-radius: 0;">
    <div class="container">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a title="设置"><span class="glyphicon glyphicon-cog"></span></a></li>
        <li><a @click="logout" title="退出"><span class="glyphicon glyphicon-off"></span></a></li>
      </ul>
    </div>
  </nav>
</template>
